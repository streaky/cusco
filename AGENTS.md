...
- Keep llama.cpp changes behind the versioned C ABI in `native/include/cusco_executor.h` (currently ABI version 12). Rust should not depend directly on unstable llama.cpp internals.
